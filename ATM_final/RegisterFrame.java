...
public class RegisterFrame extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submiButton) {
            ...
            // I checked if the address is empty in the first general if
            // if (address.isEmpty()) {
            // JOptionPane.showMessageDialog(this, "Please enter your address.", "Error",
            // JOptionPane.ERROR_MESSAGE);
            // return;
            // }
            ...
            // if (!phone.matches("\\d{4}[-\\.\\s]?\\d{3}[-\\.\\s]?\\d{4}")) {
            ...
            String userData = accNum + ":" + fName + ":" + lName + ":" + address + ":" + pin + ":" + edu + ":" + occ + ":" + phone + ":" + dob;

            AccNum_PinCode accNum_pinCode = new AccNum_PinCode();
            accNum_pinCode.addUser(accNum, pin, userData);
